            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-9 text-center">
                        <h1 class="mb-0 bread">Thành công</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 heading-section text-center mb-4">
                        <h2 class="mb-4">Đơn hàng đã được tạo</h2>
                        <p>Sắp tới chúng tôi sẽ giao sản phẩm của bạn đến địa chỉ đã định.</p>
                        <p>Nếu muốn mua thêm, bạn có thể <inertia-link href="/" >tạo một đơn hàng khác</inertia-link>.</p>
                    </div>
                </div>
            </div>
        </section>
